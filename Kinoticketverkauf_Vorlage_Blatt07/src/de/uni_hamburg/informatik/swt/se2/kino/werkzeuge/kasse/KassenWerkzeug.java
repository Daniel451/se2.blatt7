...
public class KassenWerkzeug
{
	...
	public KassenWerkzeug(Kino kino)
	{
		...
		registriereDatumAuswaehlAktionen();
		registriereVorstellungAuswaehlAktion();
	 ...
	 * 
	 */
	private void registriereDatumAuswaehlAktionen()
	{
		_datumAuswaehlWerkzeug.addObserver(new Observer()
		{
			...
			{
				_vorstellungAuswaehlWerkzeug.setTagesplan(_kino
				      .getTagesplan((Datum) arg));
			}
		});
	}
	 ...
	 * 
	 */
	private void registriereVorstellungAuswaehlAktion()
	{
		_vorstellungAuswaehlWerkzeug.addObserver(new Observer()
		{
			...
			public void update(Observable o, Object arg)
			{
				_platzVerkaufsWerkzeug.setVorstellung((Vorstellung)arg);
			}
		});
	}
